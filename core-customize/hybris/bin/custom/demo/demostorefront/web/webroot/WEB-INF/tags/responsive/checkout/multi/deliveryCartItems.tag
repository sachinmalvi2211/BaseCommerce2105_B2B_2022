		...
		<li class="checkout-order-summary-list-items">
            ...
            <hr>
			 <c:if test="${not empty entry.product.carbonFootPrintWeight && entry.product.carbonFootPrintWeight != '0'}">
				<div class="qty"><img src="https://cdn-icons-png.flaticon.com/512/2862/2862791.png" alt="Kg(s)CO2e"
                   width="30" height="30">
                    <b>${entry.product.carbonFootPrintWeight} Kg(s)CO2e </b>
                </div>
                </c:if>

                <c:if test="${entry.product.code == 'CarbonOffsetProduct'}">
                    <div class="qty"><b>Total Cart's </b><img src="https://cdn-icons-png.flaticon.com/512/2862/2862791.png" alt="Kg(s)CO2e"
                       width="30" height="30">
                        <b>${entry.carbonFootPrintWeight} Kg(s)CO2e </b>
                    </div>
                </c:if>
				<div>
				<span class="label-spacing"><spring:theme code="order.itemPrice" />:</span>
				  <c:choose>
                                   <c:when test="${entry.product.code == 'CarbonOffsetProduct'}">
