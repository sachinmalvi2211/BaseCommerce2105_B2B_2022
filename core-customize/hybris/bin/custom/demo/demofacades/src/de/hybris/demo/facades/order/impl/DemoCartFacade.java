package de.hybris.demo.facades.order.impl;
...
public class DemoCartFacade implements CartFacade
{
    ...
    private static final Logger LOG = Logger.getLogger(DemoCartFacade.class);
    ...
    public CartData getSessionCart()
    {
        ...
        if (hasSessionCart())
        {
            ...
            try {
                ...
                LOG.error("Error while calculating cart : "+cart.getCode(), e);
            }
            if(null != cart)
            {
    ...
    @Override
    public void updateCartEntrySustainanble(final long entryNumber, final boolean isSustainanble)
            throws CommerceCartModificationException
    {
        // TO DO 
    }
